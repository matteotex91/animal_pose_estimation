...
""" This is a working example of tflite yolo pose model properly working
The output data have been compared with the one produced in the kotlin code on a mobile emulator : it is exactly the same
The displayed data here is coherent with a frame and keypoints recognition
...
# Read the image
image_path = "/Users/matteotex/Documents/VSC/matteotex/animal_pose_estimation/pretrained/images/image1.png"
...
cv2.imwrite("test-tflite.png", image2)
